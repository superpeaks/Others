Logistic regression is a **supervised machine learning algorithm** primarily used for **classification tasks**, especially **binary classification**. Here's a comprehensive breakdown:
